...
io.popen("mkdir ALLAAM_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls ALLAAM_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
download_to_file('https://raw.githubusercontent.com/TEAMALLAM/ALLAAM/master/allam.lua', 'allam.lua') 
download_to_file('https://raw.githubusercontent.com/TEAMALLAM/ALLAAM/master/start.lua', 'start.lua') 
dofile('allam.lua')  
return false
end
...
if text == 'الملفات' and DevALLAM(msg) then
t = '☑┇جميع الملفات : \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n'
i = 0
for v in io.popen('ls ALLAAM_Files'):lines() do
if v:match(".lua$") then
...
if DevTshake(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAMALLAM/files_ALLAAM/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📂┇اهلا بك في متجر ملفات علامx \n📮┇الملفات الموجوده حاليا \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n\n"
local TextE = "\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n📌┇تدل علامة (✔) الملف مفعل\n".."📌┇تدل علامة (✖) الملف معطل\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("ALLAAM_Files/"..name,"r")
if ALLAAM_File_is_Found then
io.close(allam_File_is_Found)
ALLAAMFile = "(✔)"
else
ALLAAMFile = "(✖)"
end
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEAMALLAM/files_ALLAAM/master/files_ALLAAM/"..file)
if res == 200 then
os.execute("rm -fr ALLAAM_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('allam.lua')  
else
...
if text == 'السورس' or text == 'سورس' or text == 'السورس' or text == 'يا سورس' then
Text = [[
🌐┇ Welcome to Source
🚩┇[ CH 'Α' ](t.me/source_allam)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
┇[ALLAM TEAM](t.me/A_L_llam)


┇[CH 'R'](t.me/REDDEVIILL)
 
 
┇[CH 'A'](t.me/source_allam)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
[📮┇ConnectDeV](t.me/A_L_L_A_Mbot)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
if res then
if text ==  'تفعيل' and not DevBot(msg) and not database:get(bot_id.. ALLAM:Free:Add:Bots ) then 
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@source_allam] ⚜️')   
return false 
end end
